...
mf_GM2PNG(url); % with output argument to just get the URL

% Alternative, see help mf_GM2PNG help mf_GM2FIG
%mf_GM2PIC(url,'png')
%mf_GM2PIC(url,'satelite,'png')
%mf_GM2PIC(url,'hybrid','tiff')
