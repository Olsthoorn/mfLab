...
% and put it on a figure with Lat Lon coordinates
%
% USAGE:
%    test_GM_PIC_LL
%
...
[W S N E]=mf_GM_PIC_LL(url); % with output argument to just get the URL

plot(url.path(1).LATLON(:,2),url.path(1).LATLON(:,1),'ro');
