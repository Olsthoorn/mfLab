%% NHI submodel Amsterdam, North-Holland
% This file models an area around the location near Amsterdam.
...
if isempty(d)
    error('%s: kml file missing',mfilename);
end
...
ncells = 80; % means that the model will be 2*80*NHIcelsize = 40 km square
