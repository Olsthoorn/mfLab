...
%% SIMULATION4: backward endpoint simulation (see manual p36ff 43)
% TO 130221
...
zone= [1 3 5 1 5 7]; % as defined in ZONE see mf_adaptALL.m
...
pGrp = mpath_particleGroupObj(gr,zone,'name',basename,'IFace',6,'placement',5,'LineSpec','bo');
