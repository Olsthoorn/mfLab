...
%% SIMULATION5: backward multiple release endpoint simulation (see manual p47ff)
% TO 130221
...
pGrp = mpath_particleGroupObj(gr,ismember(ZONE,zone),'name',basename,'IFace',[1 2 3 4 6],'placement',10,'LineSpec','bo');
