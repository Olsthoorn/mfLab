% TestThesis2  Flow paths in three dimension examples 2 and 3 of my PhD Thesis, p108 and p109
% to 011004
...
if 1	%example Thesis 3, has holes in the aquitard, one somewhere in the area and one below the river
I=find(xm>700  & xm<1000); J=find(ym>1200 & ym<1500); kv(J,I,3)=30;  % hole in the aquitarad
I=find(xm>0  & xm<200); J=find(ym>0 & ym<200); kv(J,I,3)=30;			% hole below river
end
...
[ptcl]=modpath3(x,y,z,Por,QRF,QFF,QLF,plist,times);			% modpath
