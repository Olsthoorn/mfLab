...
%% Select the material value for the actual grid given by gridObj

% merge grid and configuration
% x-direction

[values2,I1,I2,dx] = gridsTransver(xGr1,values1,xGr2,'k');
...
[~,I1,I2]=gridsTransfer([Conf.xL(1) Conf.xR]),.gr.xGr,'k');
