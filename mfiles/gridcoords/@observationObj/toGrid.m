...
% expand HK to reflext the new grid and compute the well
% info as usual
...
if isempty(o)
    error(['%s: No well remain in the model. This implies that all the well\n',...
          'screens are at least partly outside the model ! Therefore,\n',...
          'check z-coordinates of screens and compare them with the grid layer elevations.\n',...
