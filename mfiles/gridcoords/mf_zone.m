function [Values,Conf,material]=mf_zone(basename,xGr,yGr,zGr,config,mat,parnam)
...
%
% ToDO: repalce by xsConfObj
%
% See also: xsConfObj mf_conf, mf_setwells mf_plotConf
%
% TO 110319
