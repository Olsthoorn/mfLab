...
%
%   Any text indicating what to plot is used in plot title
%
...
%
%  ToDo: replace by animateObj, this thing is far too complicated, oudated
%        use wellObj, modernize entire files
%
% See also: movie_xsec
%
% TO 091121
...
topview = imread(tpvwjpg); [topview,map]=rgb2ind(topview,256); topview=flipud(topview);
