function [out1,out2]=mf_imagemodel(figFileName,uMdl,vMdl,DX,DY)
%IMAGEMODEL 
%    reactangle uMdl vMdl has realworld size DX, DY
...
%
%EXAMPLE
%   fig=mf_imageModel(figFileName,uMdl,vMdl,DX,DY); 
%    Read the image and set the axes such that the pixel
%    or ...
%   [uMdl,vMdl]=mf_iImageModel(figFileName,DX,DY)
