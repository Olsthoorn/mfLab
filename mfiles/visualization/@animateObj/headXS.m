function o = headXS(o,varargin)
%ANIMATEOBJ/HEADXS -- shows transient heads in cross section along x-axis
%
% USAGE:
...
% SEE ALSO: animateObj.head2D and animateObj.conc2D
%
% TO 130403


o = o.head2D('x',varargin{:});
