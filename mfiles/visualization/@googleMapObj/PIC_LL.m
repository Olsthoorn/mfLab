function [W S E N]=mf_GM_PIC_LL(url,varargin)

% MF_GM_PIC_NE: Retrieves a goolge map image and puts it in Lat Lon axis
%
...
[N W]=mf_GMpix2LL(ix,iy,url.zoom,pxW,pyN);
[S E]=mf_GMpix2LL(ix,iy,url.zoom,pxE,pyS);
